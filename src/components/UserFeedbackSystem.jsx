...
// @ts-ignore;
import { ArrowLeft, History, Bell, Star, ThumbsUp, MessageSquare, Flag, Bug, Lightbulb, Heart, TrendingUp, BarChart3, CheckCircle, Comments, Upload, ChevronLeft, ChevronRight, Save, PaperPlane, Filter } from 'lucide-react';
            ...
            <CardContent className="p-8">
              ...
              <form onSubmit={handleReviewSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label className="text-white text-sm mb-2 block">评价类型</label>
                    <select value={reviewType} onChange={e => setReviewType(e.target.value)} className="w-full bg-white/10 border border-white/30 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-white/50">
                      <option value="product">产品评价</option>
