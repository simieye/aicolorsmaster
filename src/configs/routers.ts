...
import AI_ASSISTANT-ENHANCED from '../pages/ai-assistant-enhanced.jsx';
export const routers = [{
  ...
  id: "user-feedback-complete",
  component: USER_FEEDBACK-COMPLETE
}, {
  ...
  id: "ai-assistant-enhanced",
  component: AI_ASSISTANT-ENHANCED
}]