...
export default function UserFeedbackPage(props) {
  ...
  return <div style={style} className="min-h-screen bg-gradient-to-br from-purple-600 via-blue-600 to-cyan-600">
      {/* 顶部导航 */}
      <TopNavigation currentPage="user-feedback" />
      
      {/* 主内容区 */}
      <main className="container mx-auto px-4 py-8 pb-24">
        <UserFeedback onBack={handleBack} onMyReviews={handleMyReviews} onNotifications={handleNotifications} />
      </main>

      {/* 底部导航 */}
      <TabBar currentPage="user-feedback" />
    </div>;
}