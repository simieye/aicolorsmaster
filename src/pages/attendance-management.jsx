...
export default function AttendanceManagementPage(props) {
  const {
    $w,
    style
  } = props;
  ...
  return <div style={style} className="min-h-screen bg-gradient-to-br from-purple-600 via-blue-600 to-cyan-600">
      {/* 顶部导航 */}
      <TopNavigation currentPage="attendance-management" />
      
      {/* 主内容区 */}
      <main className="container mx-auto px-4 py-8 pb-24">
        <AttendanceManagement onBack={handleBack} onSettings={handleSettings} />
      </main>

      {/* 底部导航 */}
      <TabBar currentPage="attendance-management" />
    </div>;
}