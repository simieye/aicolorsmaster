...
// @ts-ignore;
import { ArrowLeft, Crown, Users, UserTie, UserFriends, Flask, Boxes, Star, ShoppingCart, PlayCircle, Calendar, Phone, MessageCircle, MapPin, Download, Cloud, Brain, Check, Store, Building, City, Package, Zap, Award } from 'lucide-react';

// @ts-ignore;
import { TabBar } from '@/components/TabBar';
// @ts-ignore;
import { TopNavigation } from '@/components/TopNavigation';
export default function AIStoreManagementPage(props) {
  const {
    $w,
    style
  } = props;
  ...
  const productData = {
    ...
    description: '全能型门店管理解决方案，集成店长CEO面板、员工管理、发型师管理、客户管理、配方管理、品牌染膏库存管理等核心功能',
    features: ['店长CEO面板', '员工管理', '发型师管理', '客户管理', '配方管理', '品牌染膏库存'],
    cloudArchitecture: {
      deployment: '云端SaaS',
      sync: '实时同步',
      backup: '多重备份',
  ...
  const coreFeatures = [{
    ...
    bgColor: 'bg-blue-500',
    title: '店长CEO面板',
    description: '全方位数据监控，实时经营分析，智能决策支持，助力门店高效运营'
  }, {
    id: 2,
    icon: Users,
    ...
    title: '员工管理',
    description: '员工档案管理、考勤排班、绩效考核、薪酬管理，提升团队效率'
  }, {
    id: 3,
    icon: UserTie,
    ...
    title: '发型师管理',
    description: '专业技能管理、客户评价、业绩统计、培训记录，打造专业团队'
  }, {
    id: 4,
    icon: UserFriends,
    ...
    title: '客户管理',
    description: '客户档案、消费记录、偏好分析、会员管理，提升客户满意度'
  }, {
    id: 5,
    icon: Flask,
    color: 'text-red-400',
    bgColor: 'bg-red-500',
    title: '配方管理',
    description: '染发配方库、效果记录、成本分析、智能推荐，优化配方使用'
  }, {
    id: 6,
    icon: Boxes,
    color: 'text-teal-400',
    bgColor: 'bg-teal-500',
    title: '品牌染膏库存',
    description: '库存监控、智能补货、批次管理、成本控制，降低运营成本'
  }];
  ...
  const useScenarios = [{
    ...
    title: '单体美发店',
    description: '适合中小型美发店，实现数字化管理',
    benefits: ['一站式管理', '成本控制', '效率提升']
  }, {
    id: 2,
    icon: Building,
    ...
    benefits: ['多店管理', '统一标准', '数据共享']
  }, {
    id: 3,
    icon: City,
    color: 'from-orange-500 to-red-600',
    title: '美发集团',
    description: '集团级管控，实现全面数字化',
    benefits: ['集团管控', '智能决策', '品牌管理']
  }];

  // 智能分析特点
  const analysisFeatures = [{
    title: '经营数据分析',
    description: '多维度数据分析，洞察经营状况'
  }, {
    title: '智能预测算法',
    description: '基于历史数据预测未来趋势'
  }, {
    title: '异常检测系统',
    description: '自动识别异常情况，及时预警'
  }, {
    title: '优化建议引擎',
    description: 'AI驱动的运营优化建议'
  }];
  ...
  return <div style={style} className="min-h-screen bg-gradient-to-br from-purple-600 via-blue-600 to-cyan-600">
      {/* 顶部导航 */}
      <TopNavigation currentPage="ai-store-management" />
      ...
      <main className="container mx-auto px-4 py-8 pb-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <div className="flex items-center space-x-6 mb-8">
                <div className="flex items-center space-x-2">
                  <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white px-6 py-3 rounded-lg">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-blue-500 text-white p-4 rounded-xl">
                ...
                <p className="font-semibold">全能门店管理</p>
                <p className="text-sm">效率提升45%</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-white/80">六大核心功能，打造智能门店管理</p>
          </div>
        ...
        <section className="mb-16">
          <Card className="bg-white/10 backdrop-blur-md border-white/20">
            <CardContent className="p-8 text-center">
              <h2 className="text-3xl font-bold text-white mb-4">立即升级您的门店管理</h2>
      ...
      {/* 底部导航 */}
      <TabBar currentPage="ai-store-management" />
    </div>;
}