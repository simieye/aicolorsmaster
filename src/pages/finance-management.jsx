...
export default function FinanceManagementPage(props) {
  ...
  return <div style={style} className="min-h-screen bg-gradient-to-br from-purple-600 via-blue-600 to-cyan-600">
      {/* 顶部导航 */}
      <TopNavigation currentPage="finance-management" />
      
      {/* 主内容区 */}
      <main className="container mx-auto px-4 py-8 pb-24">
        <FinanceManagement onBack={handleBack} onExportReport={handleExportReport} onSettings={handleSettings} />
      </main>

      {/* 底部导航 */}
      <TabBar currentPage="finance-management" />
    </div>;
}