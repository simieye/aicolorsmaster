...
export default function UserFeedbackSystemPage(props) {
  const {
    $w,
    style
  } = props;
  ...
  return <div style={style} className="min-h-screen bg-gradient-to-br from-purple-600 via-blue-600 to-cyan-600">
      {/* 顶部导航 */}
      <TopNavigation currentPage="user-feedback-system" />
      
      {/* 主内容区 */}
      <main className="container mx-auto px-4 py-8 pb-24">
        <UserFeedbackSystem onBack={handleBack} onMyReviews={handleMyReviews} onNotifications={handleNotifications} />
      </main>

      {/* 底部导航 */}
      <TabBar currentPage="user-feedback-system" />
    </div>;
}